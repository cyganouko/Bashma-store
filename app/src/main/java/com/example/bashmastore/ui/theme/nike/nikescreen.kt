package com.example.bashmastore.ui.theme.nike
...
@Composable
fun NikeScreen(navController: NavController){
                        ...
                        Row {
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.sneak2),
                        ...
                        Row {
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.sneak3),
                                        contentDescription = "home",
                                        modifier = Modifier.fillMaxSize(),
                                        contentScale = ContentScale.Crop
                                    )
                        ...
                        Row {
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.sneak4),
                                        contentDescription = "home",
                                        modifier = Modifier.fillMaxSize(),
                                        contentScale = ContentScale.Crop
                                    )
                        ...
                        Row {
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.sneak5),
                                        contentDescription = "home",
                                        modifier = Modifier.fillMaxSize(),
                                        contentScale = ContentScale.Crop
                                    )
                        ...
                        Row {
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.snaek6),
                                        contentDescription = "home",
                                        modifier = Modifier.fillMaxSize(),
                                        contentScale = ContentScale.Crop
                                    )
                        ...
                        Row {
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.snaek7),
                                        contentDescription = "home",
                                        modifier = Modifier.fillMaxSize(),
                                        contentScale = ContentScale.Crop
                                    )
                        ...
                        Row {
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        painter = painterResource(id = R.drawable.sneak9),
                                        contentDescription = "home",
                                        modifier = Modifier.fillMaxSize(),
                                        contentScale = ContentScale.Crop
                                    )
...
fun NikeScreenPreview(){
    NikeScreen(rememberNavController() )
}