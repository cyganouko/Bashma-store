package com.example.bashmastore.ui.theme.ladswear
...
@Composable
fun LadsWearScreen(navController: NavController){
                            ...
                            Row {
                                Card(
                                    ...
                                    Box(
                                        ...
                                        Image(
                                            painter = painterResource(id = R.drawable.lad12),
                                            contentDescription = "home",
                                            modifier = Modifier.fillMaxSize(),
                                            contentScale = ContentScale.Crop
                                        )
                            ...
                            Row {
                                Card(
                                    ...
                                    Box(
                                        ...
                                        Image(
                                            painter = painterResource(id = R.drawable.lad3),
                                            contentDescription = "home",
                                            modifier = Modifier.fillMaxSize(),
                                            contentScale = ContentScale.Crop
                                        )
                            ...
                            Row {
                                Card(
                                    ...
                                    Box(
                                        ...
                                        Image(
                                            painter = painterResource(id = R.drawable.lad4),
                                            contentDescription = "home",
                                            modifier = Modifier.fillMaxSize(),
                                            contentScale = ContentScale.Crop
                                        )
                            ...
                            Row {
                                Card(
                                    ...
                                    Box(
                                        ...
                                        Image(
                                            painter = painterResource(id = R.drawable.lad5),
                                            contentDescription = "home",
                                            modifier = Modifier.fillMaxSize(),
                                            contentScale = ContentScale.Crop
                                        )
                            ...
                            Row {
                                Card(
                                    ...
                                    Box(
                                        ...
                                        Image(
                                            painter = painterResource(id = R.drawable.lad6),
                                            contentDescription = "home",
                                            modifier = Modifier.fillMaxSize(),
                                            contentScale = ContentScale.Crop
                                        )
                            ...
                            Row {
                                Card(
                                    ...
                                    Box(
                                        ...
                                        Image(
                                            painter = painterResource(id = R.drawable.lad7),
                                            contentDescription = "home",
                                            modifier = Modifier.fillMaxSize(),
                                            contentScale = ContentScale.Crop
                                        )
...
fun LadsWearScreenPreview(){
    LadsWearScreen(rememberNavController() )
}